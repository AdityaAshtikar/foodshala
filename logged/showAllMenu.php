    ...
    ?>
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-text" id="order-button">
                <?php if (($logged && $is_customer == 1) || !$logged) { ?>
                    <a href="ajax/order.php?id=<?php echo $item['id']; ?>" class="btn btn-primary btn-block border-0">Order Now</a>
                <?php } else { ?>
